...
enum PresetPrompts {
    ...
    static let all: [(name: String, text: String)] = [
        ("Bonsai tree", "a meticulously pruned bonsai tree in a ceramic pot, soft studio lighting, photorealistic"),
        ("Humpback whale", "a humpback whale breaching at sunrise, backlit spray, dramatic ocean, photorealistic"),
        ("Jellyfish", "a translucent bioluminescent jellyfish drifting in deep blue water, highly detailed"),
        ("Mountain cabin", "a cozy wooden cabin in snowy mountains at dusk, warm window light, photorealistic"),
        ("Weathered sailor", "portrait of a weathered old sailor with a thick grey beard, dramatic side light, photorealistic"),
    ]
}
